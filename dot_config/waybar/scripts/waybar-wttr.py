...
data['tooltip'] += f"Wind: {weather['current_condition'][0]['windspeedMiles']}Mph/h\n"
data['tooltip'] += f"Humidity: {weather['current_condition'][0]['humidity']}%\n"
data['tooltip'] += f"Risk of Rain: {weather['weather'][0]['hourly'][int(datetime.now().hour / 3)]['chanceofrain']}%\n"
